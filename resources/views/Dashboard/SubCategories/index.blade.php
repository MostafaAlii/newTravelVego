...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{ trans('dashboard/sections.subCategory') }}</h4>
...
@section('content')
                    ...
                    <div class="card mg-b-20">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('dashboard/sections.show_all_subCategory') }}</h4>
                                ...
                                <table id="example" class="table key-buttons text-md-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom-0">{{ trans('dashboard/sections.related_category') }}</th>
                                    ...
                                    <tbody>
                                        @foreach($subCategories as $subCategory)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale" data-toggle="modal" href="#edit{{$subCategory->id}}">
                                                        <i class="las la-pen"></i>
                                                    </a>
                                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale" data-toggle="modal" href="#delete{{$subCategory->id}}">
        ...
        @include('Dashboard.SubCategories.btn.add')
