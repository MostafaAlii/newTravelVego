...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{ trans('dashboard/attributeOption.show_all_attributeOption') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
        </div>
    ...
    <div class="d-flex my-xl-auto right-content">
        <div class="pr-1 mb-3 mb-xl-0">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add">
                {{ trans('dashboard/attributeOption.add_new_attributeOption') }}
           </button>
        </div>
    </div>
</div>
                    ...
                    <div class="card mg-b-20">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('dashboard/attributeOption.show_all_attributeOption') }}</h4>
