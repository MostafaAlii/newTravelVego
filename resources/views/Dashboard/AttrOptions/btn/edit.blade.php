<!-- Modal -->
<div class="modal fade" id="edit{{$Option->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
            ...
            <form action="{{ route('AttributeOptions.update', 'test') }}" method="post" autocomplete="off">
                {{ method_field('patch') }}
                {{ csrf_field() }}
                <div class="modal-body">
                    <input type="hidden" name="id" class="form-control" value="{{ $Option->id }}" />
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ $Option->name }}" class="form-control" placeholder="{{ trans('dashboard/attributeOption.attributeOption_name') }}" />
                        @error("name")
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="option_price" value="{{ $Option->option_price }}" class="form-control" placeholder="{{ trans('dashboard/attributeOption.enter_attributeOption_price_placeholder') }}" />
                        @error("option_price")
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
