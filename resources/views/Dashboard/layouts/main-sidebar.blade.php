<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/Dashboard/img/brand/logo.png')}}" class="main-logo" alt="logo"></a>
				<a class="desktop-logo logo-dark active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/Dashboard/img/brand/logo-white.png')}}" class="main-logo dark-theme" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/Dashboard/img/brand/favicon.png')}}" class="logo-icon" alt="logo"></a>
				<a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/Dashboard/img/brand/favicon-white.png')}}" class="logo-icon dark-theme" alt="logo"></a>
			</div>
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">{{ trans('dashboard/sidebar.main_sidebar_title') }}</li>
					<!-- Start Home Dahboard -->
					<li class="slide">
						<a class="side-menu__item" href="{{ url('/' . $page='index') }}">
							...
							<span class="side-menu__label">{{ trans('dashboard/sidebar.main_sidebar_home') }}</span>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li>
								<a class="slide-item" href="{{ route('Groups.index') }}">
									{{trans('dashboard/sidebar.show_all_groups')}}
									<span class="badge badge badge-success float-right side-badge">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							...
							<span class="side-menu__label">{{ trans('dashboard/sidebar.main_sidebar_section') }}</span>
							<i class="angle fe fe-chevron-down"></i>
						</a>
						<ul class="slide-menu">
							<li>
								<a class="slide-item" href="{{ route('Categories.index') }}">
									{{trans('dashboard/sidebar.show_all_section')}}
									<span class="badge badge badge-success float-right side-badge">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							...
							<span class="side-menu__label">{{ trans('dashboard/sidebar.main_sidebar_sub_section') }}</span>
							<i class="angle fe fe-chevron-down"></i>
						</a>
						<ul class="slide-menu">
							<li>
								<a class="slide-item" href="{{ route('SubCategories.index') }}">
									{{trans('dashboard/sidebar.show_all_section')}}
									<span class="badge badge badge-success float-right side-badge">
										{{ \App\Models\Category::parent()->count() }}
									</span>
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							...
							<span class="side-menu__label">{{ trans('dashboard/country.country_title_in_sidebar') }}</span>
							<i class="angle fe fe-chevron-down"></i>
						</a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('Countries.index') }}">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('Provinces.index') }}">
								{{ trans('dashboard/province.show_all_province') }}</a></li>
						</ul>
					</li>
					<!-- End Provinces -->
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							...
							<span class="side-menu__label">{{ trans('dashboard/area.area_title_in_sidebar') }}</span>
							<i class="angle fe fe-chevron-down"></i>
						</a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('Areas.index') }}">
								{{ trans('dashboard/area.show_all_area') }}</a></li>
						</ul>
					</li>
					<!-- End Areas -->
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							...
							<span class="side-menu__label">{{ trans('dashboard/currency.currency_title_in_sidebar') }}</span>
							<i class="angle fe fe-chevron-down"></i>
						</a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('Currencies.index') }}">
								{{ trans('dashboard/currency.show_all_currency') }}</a></li>
						</ul>
					</li>
					<!-- End Currency -->
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							...
							<span class="side-menu__label">{{ trans('dashboard/appointment.appointmentSections') }}</span>
							<i class="angle fe fe-chevron-down"></i>
						</a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('Appointments.index') }}">
								{{ trans('dashboard/appointment.show_all_appointment_in_sidebar') }}</a></li>
						</ul>
					</li>
					<!-- End Appointments -->
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							...
							<span class="side-menu__label">{{ trans('dashboard/terms.terms') }}</span>
							<i class="angle fe fe-chevron-down"></i>
						</a>
						<ul class="slide-menu">
							<li>
								<a class="slide-item" href="{{ route('PrivacyTerms.index') }}">
									{{ trans('dashboard/terms.show_all_privacyTerms_in_sidebar') }}
								</a>
							</li>
							<li>
								<a class="slide-item" href="{{ route('CanclationTerms.index') }}">
					...
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
							...
							<span class="side-menu__label">{{ trans('dashboard/servicePriceSections.servicePriceSections_title_in_sidebar') }}</span>
							<i class="angle fe fe-chevron-down"></i>
						</a>
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('AttributeOptions.index') }}">{{ trans('dashboard/attribute.attribute_options_in_sidebar') }}</a></li>
						</ul>
					</li>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                            ...
                            <span class="side-menu__label">{{ trans('dashboard/service.services') }}</span>
                            <i class="angle fe fe-chevron-down"></i>
                        </a>
                        <ul class="slide-menu">
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}">
                            ...
                            <span class="side-menu__label">{{ trans('dashboard/product.product_title_in_sidebar') }}</span>
                            <i class="angle fe fe-chevron-down"></i>
                        </a>
                        <ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('Products.index') }}">{{ trans('dashboard/product.show_all_product_in_sidebar') }}</a></li>
                        </ul>
                    </li>
                    <!-- End Products -->
