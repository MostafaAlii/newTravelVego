...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{ trans('dashboard/attribute.show_all_attributes') }}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
        </div>
    ...
    <div class="d-flex my-xl-auto right-content">
        <div class="pr-1 mb-3 mb-xl-0">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add">
                {{ trans('dashboard/attribute.add_new_attribute') }}
           </button>
        </div>
    </div>
</div>
                    ...
                    <div class="card mg-b-20">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('dashboard/attribute.show_all_attributes') }}</h4>
                                        ...
                                        @foreach($Attributes as $attr)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale" data-toggle="modal" href="#delete{{$attr->id}}">
